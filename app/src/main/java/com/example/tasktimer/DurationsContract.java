...
public class DurationsContract {
    ...
    public static class Columns {
        ...
        public static final String DURATIONS_DESCRIPTION = TasksContract.Columns.TASK_DESCRIPTION;
        public static final String DURATIONS_START_TIME = TimingsContract.Columns.TIMING_START_TIME;
        public static final String DURATIONS_START_DATE = "StartDate";
        public static final String DURATIONS_DURATION = TimingsContract.Columns.TIMING_DURATION;
